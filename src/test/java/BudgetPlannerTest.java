...
/**
 * TestNG runner for the Budget Planner feature (TC56–TC60, US12).
 *
 * Cucumber picks up:
 *   features  → src/test/resources/features/BudgetPlanner.feature
 *   glue      → BudgetPlannerSteps, BudgetPlannerHooks, BudgetPlannerTestContext (all in default package)
 *
 * Reports:
 *   - Cucumber HTML  → target/cucumber-reports/budgetplanner/index.html
 *   - Cucumber JSON  → target/cucumber-reports/budgetplanner/cucumber.json
