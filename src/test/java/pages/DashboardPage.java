...
public class DashboardPage {
     ...
     *
     * @param baseUrl  the file:// base URL of TargetWebsite
    ...
    public List<WebElement> getFavoriteCards() {
        ...
        // Cards rendered by renderFavorites() are .mini-card elements inside #favs-list
    ...
    public void removeFavoriteAtIndex(int index) {
        ...
        // Each mini-card has a btn-remove-fav-{id} button
    ...
    /**
     * Selects BHK by the full visible option text (e.g. "2 BHK", "3 BHK").
     * The HTML options are: Any / 1 BHK / 2 BHK / 3 BHK / 4 BHK+
     */
    ...
    public boolean isPreferencesSavedAlertDisplayed() {
        // The success alert appears inside #pref-saved-alert; wait for its child .alert element
    ...
    /**
     * Enables the property-alerts toggle.
